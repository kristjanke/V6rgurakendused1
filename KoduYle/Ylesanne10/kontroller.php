	...
	case "tulemus":
		...
		if (isset($_POST['pilt']) && isset($pildid[$_POST['pilt']])) {
			if (!isset ($_SESSION['voted_for'])) { 
				...
				echo "Oled oma valiku teinud";
				// echo $_SESSION['voted_for'];
				// echo "<img src=\"$pildid[$_SESSION['voted_for']]['src']\" alt=\"$pildid[$_SESSION['voted_for']]['alt']\" />;
				echo "<p><a href=\"sessLopp.php\">alusta uuesti!</a></p>";
				
				
			// echo "Sesssioon oli olemas, väärtus oli: ".$_SESSION['voted_for'];
			break;
			}
